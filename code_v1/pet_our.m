...
%% Parameters
optsInd = struct('mit_learn',300,'mit_inn',300,'mit_out',100,'alpha',0.001,'beta',0.00005,'gamma',0.00005,'rho',0.5);
scale=5;
xi=0.4000;
lambda=0.000600;
mu=2.1;
%% Process image
tic;
[u1Ind1,v1Ind1,D1Ind1,Res1Ind1]=EST_MWCNN_DtDvPETRec(scale,xi,f,c,P,Pt,N,lambda,mu,PatchSizeRow,PatchSizeCol,StepSizeRow,StepSizeCol,FilterType,u1EM,img1,optsInd,0.001,0.00005,0.00005,0.5);
